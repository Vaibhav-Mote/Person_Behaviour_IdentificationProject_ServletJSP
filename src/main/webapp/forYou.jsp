...
<%
    int registerid1 = Integer.parseInt(request.getParameter("registerid"));
    PostService pser = new PostServiceImpl();
    List<List<Object>> posts = pser.getForYou();
    if (posts != null) {
        for (List<Object> innerList : posts) {
   ...
   <img alt="<%= filename %>" src="<%= request.getContextPath() %>/uploads/<%= filename %>" >
            ...
            <div class="likeComment">
                <form action="comment" method="post">
                    ...
                    <a href="likepost?registerid=<%= registerid1 %>&&postid=<%= postLikeCount.getPostid() %>">
